...
export const COMMAND_GET_THEME_DECLARATIONS = 'get-theme-declarations';
export const COMMAND_UPDATE_DRAG_DATA = 'update-drag-data';
export const NOTIFY_BROWSER_THEME_UPDATED = 'browser-theme-updated';
...
export const COMMAND_GET_BOOKMARK_URLS = 'get-bookmark-urls';
export const COMMAND_OPEN_BOOKMARKS    = 'open-bookmarks';
export const COMMAND_OPEN_BOOKMARKS_AS_TREE = 'open-bookmarks-as-tree';
...
export const COMMAND_REMOVE_BOOKMARK   = 'remove-bookmark';
...
export const LOADABLE_URL_MATCHER = /^(?!\s*(?:javascript|data):)[a-z][a-z0-9+.-]*:/i;
